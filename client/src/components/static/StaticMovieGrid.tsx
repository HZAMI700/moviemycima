...
import { loadMovies } from '@/lib/staticData';
...
export default function StaticMovieGrid({ limit = 24 }: Props) {
  ...
  if (items.length === 0) {
    return <div className="text-center py-10 text-dark-400">لا توجد أفلام متاحة حالياً</div>;
  }
